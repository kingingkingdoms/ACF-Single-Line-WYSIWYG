...
/* Set the text domain */
load_plugin_textdomain( 'acf-single-line-wysiwyg', false, dirname( plugin_basename(__FILE__) ) . '/lang/' ); 

/* Include field type for ACF5 */
function include_field_types_single_line_wysiwyg( $version ) {
	include_once('acf-single-line-wysiwyg-v5.php');
}
...
function register_fields_single_line_wysiwyg() {
	include_once('acf-single-line-wysiwyg-v4.php');
}
